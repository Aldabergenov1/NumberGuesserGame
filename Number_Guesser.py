...
print('Случайное число задано, теперь, попробуйте его угадать! После каждой неудачной попытки, вам будет дана подсказка, больше ли ваше предпологаемое число, или меньше.')
